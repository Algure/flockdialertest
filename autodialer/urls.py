...
urlpatterns = [
    ...
    path('api/user/login/', dialerapp.api_views.UserLoginView.as_view()),
    path('api/user/change-password/', dialerapp.api_views.UserChangePasswordView.as_view()),
